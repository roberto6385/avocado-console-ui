...
// height
export const AVOCADO_HEIGHT = '60px'; // tab container, logo container
export const AVOCADO_SUB_HEIGHT = '50px'; // new folder container, (ssht, sftp nav)
export const AVOCADO_FOLDER_HEIGHT = '40px'; // folder, server height
export const FOOTER_HEIGHT = '26px'; // footer height
export const SFTP_TABLE_HEIGHT = '48px';
